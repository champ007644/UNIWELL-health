...
if __name__ == '__main__':
    ...
    e1 = int(input("Enter value for Age: "))
    e2 = int(input("Enter value for veg=1/non-veg=0: "))
    e3 = int(input("Enter value for weight(kg): "))
    e4 = int(input("Enter value for height(cm): "))
    ...
    if choice == 1:
        ...
        print("Invalid choice. Please enter either 1 for Weight Gain or 2 for Weight Loss.")
